...
class ReactScheduler(
    private val boundedElasticScheduler: Scheduler,
    private val lettucePublishScheduler: Scheduler,
    private val webClientPublishScheduler: Scheduler
) {
    fun getBoundedElasticScheduler(): Scheduler = boundedElasticScheduler
    fun getLettucePublishScheduler(): Scheduler = lettucePublishScheduler
    fun getWebClientPublishScheduler(): Scheduler = webClientPublishScheduler
}
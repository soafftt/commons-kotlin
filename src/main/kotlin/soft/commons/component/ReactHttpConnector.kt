 ...
 */
@Component
class ReactHttpConnector(private val reactorClientHttpConnector: ReactorClientHttpConnector) {
    fun getReactorClientHttpConnector(): ReactorClientHttpConnector = reactorClientHttpConnector
}